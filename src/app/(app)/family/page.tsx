...
export default async function FamilyPage() {
  ...
  return <div className="space-y-8"><PageHeader description={household?.nazwa} title={t.modules.family.title} /><PeopleContent householdName={household?.nazwa ?? ""} invitations={invitations} isAdministrator={isAdministrator} loadError={Boolean(membersError)} members={members} /></div>;
}
